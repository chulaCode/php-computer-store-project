            ...
            <div class="header__content row">
                ...
                <nav class="header__nav-wrap">
                    ...
                    <ul class="header__nav">
                        ...
                        <li class="">
                            <a href="order.php" title="">Order List</a>
                        </li>
            ...
            <?php foreach ($result as $product) {?>
                ...
                <article class="masonry__brick entry format-standard" data-aos="fade-up">
                    ...
                    <div class="entry__text">
                        ...
                        <div class="entry__meta">
                            <span >
                            <a href="buy.php?id=<?php echo $product['p_id']; ?>"><button type="button" class="" style="background-color:#01579B; color:white">Buy</button></a>
                            
                            <a href="rent.php?id=<?php echo $product['p_id']; ?>"><button type="button" class="" style="background-color:#00C853; color:white">Rent</button></a></span>
